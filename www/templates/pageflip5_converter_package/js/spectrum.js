    ...
    function spectrum(element, o) {
        ...
        function updateHelperLocations() {
            ...
            if(allowEmpty && isEmpty) {
                ...
                var dragX = s * (dragWidth-6);
                var dragY = (dragHeight-6) - (v * (dragHeight-6));
                dragX = Math.max(
                    -dragHelperHeight,
                ...
                var alphaX = currentAlpha * (alphaWidth-6);	/* ****/
                alphaSlideHelper.css({
                    "left": (1 + alphaX - (alphaSlideHelperWidth / 2)) + "px"	/* ****/
                });

                // Where to show the bar that displays your current selected hue
                var slideY = (currentHue) * (slideHeight-6);
                slideHelper.css({
                    "top": (4 + slideY - slideHelperHeight) + "px"
                });
            }
        }
