			...
			<div id="website-content" class="website-content">
				...
				<div class="content">
					...
					<div id="pdfupload" class="faded">
						<form id="uploadform" method="post" action="process_converter.php" enctype="multipart/form-data">
								...
								<form>
									<div class="smallblock">
										...
										<select name="resolution" class="renderinvalidator">
											...
											<option value="4">Larger - 1350x1350</option>
											<option value="3">Extra Large - 2048x2048</option>
										</select>
									</div>
									<div class="blockul">
					...
					<div id="pdfdownload" class="faded">
						<div id="downloadcentered">
							...
							<div id="downloadcontent" class="faded">
								...
								<form action="process_converter.php" method="post" id="downloadsubmit" name="downloadsubmit">
									<div>
