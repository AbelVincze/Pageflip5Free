Pageflip5 README FIRST!
	...
	By default, Pageflip5 can be used offline, but if you wich to publish it (online or offline) You have to create your own Key.
	...
	User can protect the publication by entering a valid code sequence, generated by the online Key Generator (http://pageflip.hu/keygen.php), in the Configuration Object.
	...
	Please read the online documentation (http://pageflip.hu/documentation.php) getting started part, about how to unlock your Pageflip.

	IMPORTANT!
	Some browsers default security settings doesn't allow offline running Pageflip5, because it uses AJAX requests. Firefox seems to be always working, Safari needs the html document to locally be re-saved. Chrome and Opera doesn't allow it. You can either upload it on a server, or a localhost. In each case, use the on-line Key Generator (http://pageflip.hu/keygen.php) to enable your domains.